...
namespace MathForGames
{
    class Scene
    {
        ...
        public void AddActor(Actor actor)
        {
            ...
            //Copy the values from old array to the new array.
            for (int i = 0; i < _actors.Length; i++)
            {
                appendedArray[i] = _actors[i];
            }
            //Set the last value in the new array to be actor we want to add.
            appendedArray[_actors.Length] = actor;
            //Set old array to hold the values of new array.
